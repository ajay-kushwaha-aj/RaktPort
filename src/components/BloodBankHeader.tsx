  ...
  return (
    <>
      <style>{`
        ...
        .bbh-wrap { font-family:'DM Sans',sans-serif; background:linear-gradient(135deg,#6b0000 0%,#8B0000 55%,#9e0000 100%); position:relative; overflow:hidden; }
        ...
        .bbh-notif-dot { position:absolute; top:-5px; right:-5px; min-width:17px; height:17px; padding:0 3px; background:#ff3737; border:2px solid #8B0000; border-radius:999px; font-size:8px; font-weight:800; color:#fff; display:flex; align-items:center; justify-content:center; animation:bbhb 1.4s ease-in-out infinite; }
      ...
      <header className="bbh-wrap sticky top-0 z-50 shadow-2xl">
        <div className="container mx-auto px-3 sm:px-5 max-w-7xl">
          <div className="flex items-center gap-2 sm:gap-3 py-3">
            ...
            {bloodRequestsCount > 0 && (
              <div className="bbh-req-pill hidden sm:flex">
                <span className="w-5 h-5 bg-red-500 rounded-full flex items-center justify-center text-[9px] font-black text-white flex-shrink-0">
          ...
          <div className="flex items-center gap-2 pb-2 sm:hidden">
            ...
            {bloodRequestsCount > 0 && (
              <span className="ml-auto text-[10px] font-bold bg-red-500/25 text-red-200 px-2 py-0.5 rounded-full">

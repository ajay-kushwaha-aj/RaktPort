...
.brand-gov{font-size:6pt;color:#6b7280;margin-top:1pt;}.brand-tag{font-size:6.5pt;color:#8B0000;font-style:italic;margin-top:2pt;font-weight:600;}
...
.sec-head.red{border-left-color:#8B0000;}.sec-head.gray{border-left-color:#374151;}
...
.rtid-lbl{font-size:6.5pt;color:#9ca3af;text-transform:uppercase;letter-spacing:1.2pt;margin-bottom:3pt;}.rtid-code{font-family:monospace;font-size:15pt;font-weight:900;color:#8B0000;letter-spacing:2pt;}
...
.blbl{font-size:6.5pt;text-transform:uppercase;color:#6b7280;font-weight:700;margin-bottom:2pt;letter-spacing:0.3pt;}.bval-lg{font-size:25pt;font-weight:900;color:#8B0000;line-height:1;}
...
<script>(function(){try{new QRious({element:document.getElementById('slip-qr'),value:${JSON.stringify(getQRPayload(request))},size:88,foreground:'#8B0000',level:'H'});}catch(e){}window.addEventListener('load',function(){setTimeout(function(){window.print();setTimeout(function(){window.close();},800);},400);});})();</script>
</body></html>`;
};

      ...
      <DialogContent className="sm:max-w-2xl max-h-[92vh] overflow-y-auto rounded-2xl p-0">
        ...
        <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 rounded-t-2xl border-b border-gray-100 dark:border-gray-800 p-5">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100" style={{ fontFamily: "Outfit,sans-serif" }}>Edit Blood Request</h2>
              <p className="text-xs text-gray-500 dark:text-gray-400">RTID: {request.rtid} · {request.status}</p>
            </div>
            <button type="button" onClick={() => { if (!saving) onClose(); }} className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center">
        ...
        {!canEdit ? (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Cannot Edit Request</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <button type="button" onClick={() => setUnitsRequired(u => Math.max(1, u - 1))} className="w-9 h-9 rounded-lg border-2 border-gray-200 dark:border-gray-700 font-bold text-gray-600 dark:text-gray-400 flex items-center justify-center">−</button>
                    ...
                    <button type="button" onClick={() => setUnitsRequired(u => Math.min(20, u + 1))} className="w-9 h-9 rounded-lg border-2 border-gray-200 dark:border-gray-700 font-bold text-gray-600 dark:text-gray-400 flex items-center justify-center">+</button>
                  </div>
                </div>
              </div>
              <div>

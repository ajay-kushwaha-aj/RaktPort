  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto p-4 pb-6 sm:pb-4">
        <div className="bg-[var(--bg-surface)] dark:bg-gray-900 rounded-2xl shadow-2xl border border-[var(--border-color)] dark:border-gray-700 overflow-hidden">
          {/* Main bar */}
          <div className="p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-start gap-3 flex-1">
              ...
              <div className="min-w-0">
                <h3 className="font-semibold text-sm text-[var(--text-primary)] dark:text-[var(--txt-inverse)] flex items-center gap-1.5">
                  🍪 We use cookies
                </h3>
                <p className="text-xs text-[var(--text-secondary)] dark:text-gray-400 mt-0.5 leading-relaxed">
            ...
            <div className="flex items-center gap-2 flex-shrink-0 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-initial text-xs font-medium px-3.5 py-2 rounded-xl border border-[var(--border-color)] dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-[var(--bg-page)] dark:hover:bg-gray-800 transition"
              >
                Essential Only
              </button>
              <button
          ...
          <button
            ...
            className="w-full px-4 py-2 flex items-center justify-center gap-1 text-[11px] text-gray-400 hover:text-[var(--text-secondary)] dark:hover:text-gray-300 transition border-t border-gray-100 dark:border-gray-800"
          >
            ...
            <div className="px-4 pb-4 space-y-3 border-t border-gray-100 dark:border-gray-800 pt-3 animate-in slide-in-from-top-2 duration-200">
              {[
                ...
                <div key={c.name} className="flex items-start gap-2.5 text-xs">
                  ...
                  <div>
                    <span className="font-semibold text-[var(--text-primary)] dark:text-gray-200">
                      {c.name}
                      {c.required && (
                    ...
                    <p className="text-[var(--text-secondary)] dark:text-gray-400 mt-0.5">{c.desc}</p>
                  </div>
                </div>
              ))}

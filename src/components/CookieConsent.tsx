...
export function CookieConsent() {
  ...
  return (
    <div
      ...
      className={`fixed bottom-0 left-0 right-0 z-[9998] transition-all duration-400 ${
        animateOut ? 'translate-y-full opacity-0' : 'translate-y-0 opacity-100 animate-in slide-in-from-bottom-8'
      }`}
    >
